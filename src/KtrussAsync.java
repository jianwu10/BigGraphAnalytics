...
public class KtrussAsync {
  ...
  public static void main(String[] args) throws Exception{
    ...
    // PrintStream out = new PrintStream(new FileOutputStream("data/"+basename+"/"+"output/ktruss/"+basename+"_ktruss_asynchronous_console.txt"));
    // System.setOut(out);

    KtrussAsync kt = new KtrussAsync("data/"+basename+"/"+basename+"-noself-sym");
    kt.supportCompute();
    kt.ktrussCompute();

    // System.out.println("Writing results to file. Be patient...");
    // PrintStream ps = new PrintStream(new File("data/"+basename+"/"+"output/ktruss/"+basename+"_ktruss_asynchronous.txt"));
